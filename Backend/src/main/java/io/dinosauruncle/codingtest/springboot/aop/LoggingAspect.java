package io.dinosauruncle.codingtest.springboot.aop;
...
public class LoggingAspect {
	...
	@AfterReturning(pointcut="execution(public * io.dinosauruncle.codingtest.springboot.*.*(..))", returning="ret")	
